...
|---|---|---|
| `TestFAQStPOChunking` | 5 | 1039 chunks, all have text, all have metadata, IDs unique, IDs prefixed correctly. |
| `TestFAQAOChunking` | 2 | Placeholder file produces 0 chunks, FAQ_ALL_SKIPPED flag raised. |
